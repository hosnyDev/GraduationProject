...
public class Qcb3Activity extends AppCompatActivity {
	 ...
	 private List<QuestionBC3> questionList;
	 ...
	 private QuestionBC3 currentQuestion;
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		  ...
		  setContentView(R.layout.activity_qcb3);

		  // view
		  mScore = findViewById(R.id.ScoreQ3b);
		  mQuestionCount = findViewById(R.id.countQuestionQ3b);
		  mTime = findViewById(R.id.timeQ3b);
		  mQuestion = findViewById(R.id.questionQ3b);
		  radioGroup = findViewById(R.id.radioGroupQ3b);
		  mR1 = findViewById(R.id.radio1Q3b);
		  mR2 = findViewById(R.id.radio2Q3b);
		  mR3 = findViewById(R.id.radio3Q3b);
		  mR4 = findViewById(R.id.radio4Q3b);
		  mNext = findViewById(R.id.btnQ3b);
...
//		  uID = mAuth.getCurrentUser().getUid();
		  ...
		  QuizDB_BC3 db = new QuizDB_BC3(this);
			   ...
			   public void onClick(View view) {
					...
					if ( !answered ) {
						 ...
						 if ( mR1.isChecked() || mR2.isChecked() || mR3.isChecked() || mR4.isChecked() ) {
							  ...
							  AlertDialog.Builder al = new AlertDialog.Builder(Qcb3Activity.this);
	 ...
	 private void showNextQuestion() {
		  ...
		  if ( questionCounter < questionCountTotal ) {
			   ...
			   mQuestion.setText(currentQuestion.getQuestionC3b());
			   mR1.setText(currentQuestion.getOption1C3b());
			   mR2.setText(currentQuestion.getOption2C3b());
			   mR3.setText(currentQuestion.getOption3C3b());
			   mR4.setText(currentQuestion.getOption4C3b());
	 ...
	 private void checkAnswer() {
		  ...
		  if ( answerNO == currentQuestion.getAnswerNoC3b() ) {
			   score++;
	 ...
	 private void showSolution() {
		  ...
		  switch (currentQuestion.getAnswerNoC3b()) {
			   case 1:
