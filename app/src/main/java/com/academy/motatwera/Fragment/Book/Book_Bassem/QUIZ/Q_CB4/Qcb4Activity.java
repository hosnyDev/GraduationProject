...
public class Qcb4Activity extends AppCompatActivity {
	 ...
	 private List<QuestionBC4> questionList;
	 ...
	 private QuestionBC4 currentQuestion;
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		  ...
		  setContentView(R.layout.activity_qcb4);


		  // view
		  mScore = findViewById(R.id.ScoreQ4b);
		  mQuestionCount = findViewById(R.id.countQuestionQ4b);
		  mTime = findViewById(R.id.timeQ4b);
		  mQuestion = findViewById(R.id.questionQ4b);
		  radioGroup = findViewById(R.id.radioGroupQ4b);
		  mR1 = findViewById(R.id.radio1Q4b);
		  mR2 = findViewById(R.id.radio2Q4b);
		  mR3 = findViewById(R.id.radio3Q4b);
		  mR4 = findViewById(R.id.radio4Q4b);
		  mNext = findViewById(R.id.btnQ4b);
...
//		  uID = mAuth.getCurrentUser().getUid();
		  ...
		  QuizDB_BC4 db = new QuizDB_BC4(this);
			   ...
			   public void onClick(View view) {
					...
					if ( !answered ) {
						 ...
						 if ( mR1.isChecked() || mR2.isChecked() || mR3.isChecked() || mR4.isChecked() ) {
							  ...
							  AlertDialog.Builder al = new AlertDialog.Builder(Qcb4Activity.this);
	 ...
	 private void showNextQuestion() {
		  ...
		  if ( questionCounter < questionCountTotal ) {
			   ...
			   mQuestion.setText(currentQuestion.getQuestionC4b());
			   mR1.setText(currentQuestion.getOption1C4b());
			   mR2.setText(currentQuestion.getOption2C4b());
			   mR3.setText(currentQuestion.getOption3C4b());
			   mR4.setText(currentQuestion.getOption4C4b());
	 ...
	 private void checkAnswer() {
		  ...
		  if ( answerNO == currentQuestion.getAnswerNoC4b() ) {
			   score++;
	 ...
	 private void showSolution() {
		  ...
		  switch (currentQuestion.getAnswerNoC4b()) {
			   case 1:
